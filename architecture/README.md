...
| [`ASA-ARCH-007-Market-Data-Platform.md`](./ASA-ARCH-007-Market-Data-Platform.md) | What are the provider-neutral observation, provider, resolution, snapshot, and replay contracts? |
