...
from strategy_runtime.adapters import UNBOUND_FULFILLMENT, build_migrated_strategy_registry


def test_all_three_migration_targets_are_registered() -> None:
    registry = build_migrated_strategy_registry(UNBOUND_FULFILLMENT)
