...
REQUIRED_ROLE_FILES = [
    ...
    "roles/researcher/INSTANTIATION_PROMPT.md",
    "roles/researcher/STARTUP_CHECKLIST.md",
    "roles/researcher/OPERATING_LOOP.md",
    "roles/researcher/CONTEXT_PACKET.md",
    "roles/researcher/REVIEW_TEMPLATE.md",
