...
|---|---:|---|---|
| `earnings_calendar` | `1.0.0` | shared + options | confirmed-event calendar candidate |
| `forward_factor` | `1.1.0` | shared + options | forward-volatility double-calendar candidate |
