...
CAPABILITY_DEMAND_CONTRACT_VERSION = "asa.capability_demand.v1"
...
class CapabilityDemand:
    ...
    def __post_init__(self) -> None:
        ...
        for name in ("maximum_age_seconds", "maximum_input_skew_seconds"):
            ...
            if value is not None and (type(value) is not int or value < 0):
                raise DomainInvariantError(f"CapabilityDemand.{name} must be non-negative")
    ...
    def demand_id(self) -> str:
        ...
        payload = {
            ...
            "maximum_input_skew_seconds": self.maximum_input_skew_seconds,
        }
