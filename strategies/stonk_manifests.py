...
EARNINGS_CALENDAR_MANIFEST = StrategyManifest(
    ...
    (
        OutputSpec("earnings_eligible", "event_window", "eligible"),
        OutputSpec("eligible", "eligibility", "result"),
        OutputSpec("gap_eligible", "expiration_select", "gap_eligible"),
        OutputSpec("selected_expirations", "expiration_select", "selected"),
        OutputSpec("actual_gap_days", "gap", "actual_gap_days"),
        OutputSpec("gap_deviation_days", "gap", "gap_deviation_days"),
        OutputSpec("structure", "calendar", "structure"),
        OutputSpec("liquidity_acceptable", "liquidity", "acceptable"),
        OutputSpec("option_volume_band", "liquidity", "volume_band"),
        OutputSpec(
            "volume_supplement_strong",
            "liquidity",
            "volume_supplement_strong",
        ...
        OutputSpec("term_structure_richness", "score", "primary"),
        OutputSpec("front_iv_vs_realized_volatility", "score", "secondary"),
...
SKEW_MOMENTUM_VERTICAL_MANIFEST = StrategyManifest(
    ...
    (),
    (
        OutputSpec("structure", "decision", "structure"),
        OutputSpec("mid_debit", "decision", "mid_debit"),
        OutputSpec("conservative_debit", "decision", "conservative_debit"),
        OutputSpec("liquidity_acceptable", "decision", "liquidity_acceptable"),
        OutputSpec("direction", "decision", "direction"),
        OutputSpec("normalized_call_skew", "decision", "normalized_call_skew"),
        OutputSpec("normalized_put_skew", "decision", "normalized_put_skew"),
        OutputSpec("call_skew_zscore", "decision", "call_skew_zscore"),
        OutputSpec("put_skew_zscore", "decision", "put_skew_zscore"),
        OutputSpec(
            "historical_valid_observations",
            "decision",
            "historical_valid_observations",
        ),
        OutputSpec("call_atm_iv_minus_rv", "decision", "call_atm_iv_minus_rv"),
        OutputSpec("put_atm_iv_minus_rv", "decision", "put_atm_iv_minus_rv"),
        OutputSpec("call_wing_iv_minus_rv", "decision", "call_wing_iv_minus_rv"),
        OutputSpec("put_wing_iv_minus_rv", "decision", "put_wing_iv_minus_rv"),
        OutputSpec(
        ...
        OutputSpec("time_series_return", "decision", "time_series_return"),
        OutputSpec(
            "cross_sectional_percentile",
            "decision",
            "cross_sectional_percentile",
        ),
        OutputSpec("comparison_peer_count", "decision", "comparison_peer_count"),
        OutputSpec("sector_relative_return", "decision", "sector_relative_return"),
        OutputSpec("bullish_core_gate", "decision", "bullish_core_gate"),
        OutputSpec("bearish_core_gate", "decision", "bearish_core_gate"),
        OutputSpec(
            "momentum_alignment_count",
            "decision",
            "momentum_alignment_count",
        ),
        OutputSpec("momentum_complete", "decision", "momentum_complete"),
        OutputSpec("score", "decision", "score"),
        OutputSpec("verdict", "decision", "verdict"),
    ),
    required_market_capabilities=_capabilities(
        MarketCapability.REAL_TIME_QUOTE_V1,
        MarketCapability.HISTORICAL_BARS_V1,
